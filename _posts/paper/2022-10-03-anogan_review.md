...
# 2. AnoGAN의 학습 방법
![anogan_fig1](/assets/images/paper/anogan/anogan_fig1.png)
...
![gan](/assets/images/paper/anogan/gan.png)
## Generator 학습
...
## GAN Loss
![gan_loss](/assets/images/paper/anogan/gan_loss.png)
> Discriminator는 V가 최대가 되도록 학습하고, Generator는 V가 최소가 되도록 학습한다.



# 2.2 AnoGAN의 동작 원리
![gan_loss](/assets/images/paper/anogan/anogan_fig2.png)
## Generator 학습
...
- Residual Loss  
![residual_loss](/assets/images/paper/anogan/residual_loss.png)  
X와 G(z1)을 통해서 나온 Fake Image를 비교한다. 즉, Latent Space에서의 z벡터를 업데이트 하기 위한 Loss이다.



- Discriminator Loss  
![discriminator_loss](/assets/images/paper/anogan/discriminator_loss.png)  
Discriminator을 통한 X의 feature와 G(z)의 feature 차이를 계산하는 Loss이다.



- Total Loss  
![total_loss](/assets/images/paper/anogan/total_loss.png)  
...
![anomaly_score](/assets/images/paper/anogan/anomaly_score.png)  
...
![experiment](/assets/images/paper/anogan/experiment.png)  
